...
class StatKey extends FlxGroup
{
	...
	public function new() 
	{
		...
		txtKey.setFormat(null, 10, 0xff00ff, "center", FlxTextBorderStyle.OUTLINE, 0x888888);
		add(txtKey);
		txtKey = new FlxText(txtKey.x+txtKey.width, txtKey.y, (FlxG.width - 20) / 5, "Luck");
		txtKey.setFormat(null, 10, 0x00ff00, "center", FlxTextBorderStyle.OUTLINE, 0x888888);
		add(txtKey);
		txtKey = new FlxText(txtKey.x+txtKey.width, txtKey.y, (FlxG.width - 20) / 5, "Logic");
		txtKey.setFormat(null, 10, 0x0000ff, "center", FlxTextBorderStyle.OUTLINE, 0x888888);
		add(txtKey);
		txtKey = new FlxText(txtKey.x+txtKey.width, txtKey.y, (FlxG.width - 20) / 5, "Physique");
		txtKey.setFormat(null, 10, 0xff0000, "center", FlxTextBorderStyle.OUTLINE, 0x888888);
		add(txtKey);
		txtKey = new FlxText(txtKey.x+txtKey.width, txtKey.y, (FlxG.width - 20) / 5, "Finesse");
		txtKey.setFormat(null, 10, 0xffff00, "center", FlxTextBorderStyle.OUTLINE, 0x888888);
		add(txtKey);
	}
